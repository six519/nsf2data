/*
	nsf2data converter for FamiTone2 audio library
	============================================================================
	----------------------------------------------------------------------------
	Created by: Alex Semenov (Shiru)
	Modified by: Ferdinand Silva
	----------------------------------------------------------------------------
	Modified a few lines of code to be able to compile the source code using g++
	============================================================================
*/
#include <stdlib.h>
#include <stdio.h>
...
int main(int argc,char *argv[])
{
	...
	if(argc<2)
	{
		...
		printf("Usage: nsf2data filename.nsf [-ca65 or -asm6][-pal or -ntsc]\n");
